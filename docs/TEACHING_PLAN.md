...
cập bằng read-only token riêng của từng tài khoản. TA công bố full commit SHA của
checkpoint, nhưng không chia sẻ personal token. Chỉ freeze `requirements.txt` sau khi
tổ hợp package đó đã chạy rehearsal thành công.
